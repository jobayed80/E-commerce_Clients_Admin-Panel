...
const Kids_Fashion_Table = () => {


  const [searchQuery, setSearchQuery] = useState('Kids Fashion');
    ...
    <Card extra="!p-[20px] text-center overflow-y-scroll"  style={{height:"50vh"}}>
                <div className="flex justify-between">
                    <button className="linear mt-1 flex items-center justify-center gap-2 rounded-lg bg-lightPrimary p-2 text-gray-600 transition duration-200 hover:cursor-pointer hover:bg-gray-100 active:bg-gray-200 dark:bg-navy-700 dark:hover:opacity-90 dark:active:opacity-80">
                        <MdOutlineCalendarToday />
                        <span className="text-sm font-medium text-gray-600">Kids Fashion</span>
                    </button>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-white capitalize bg-blueSecondary dark:bg-gray-700 dark:text-black">
                            <tr>
                                ...
                                <th scope="col" class="p-4">Kids ID</th>
...
export default Kids_Fashion_Table;
