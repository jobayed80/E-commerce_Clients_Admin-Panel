...
const Tech_Accessories = () => {


  const [searchQuery, setSearchQuery] = useState('Tech Accessories');
    ...
    <Card extra="!p-[20px] text-center overflow-y-scroll"  style={{height:"50vh"}}>
                <div className="flex justify-between">
                    <button className="linear mt-1 flex items-center justify-center gap-2 rounded-lg bg-lightPrimary p-2 text-gray-600 transition duration-200 hover:cursor-pointer hover:bg-gray-100 active:bg-gray-200 dark:bg-navy-700 dark:hover:opacity-90 dark:active:opacity-80">
                        <MdOutlineCalendarToday />
                        <span className="text-sm font-medium text-gray-600">Tech Accessories</span>
                    </button>
...
export default Tech_Accessories